...
Redesigned hardware: new schematic and PCB layout, but several parts from the original module have been reused (controller, transformer, connector, fuse and its holder, power MOSFET, output diode, trim-pot, high power resistors and electrolytic capacitors). 
...
Contents: KiCad schematic, PCB layout and supporting documentation.
